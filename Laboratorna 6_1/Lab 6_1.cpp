...
int main()
{
	...
	Print(x, SIZE);
	cout << " }" << endl;
	cout << "—ума елемент≥в масиву, €к≥ задовольн€ють умову: "
	<< Sum(x, SIZE) << endl;
	cout << " ≥льк≥сть елемент≥в у масив≥, €к≥ задовольн€ють умову: "
		<< Count(x, SIZE) << endl;
	cout << "«ам≥на елемент≥в, €к≥ задовольн€ють умову, нул€ми:"<< endl;
	cout << "x[24] = { ";
	Replace(x, SIZE);
	cout << " }" << endl;
